...
def train_and_evaluate(*,
    ...
    Xtr = filter_in_uncorrelated_features(Xtr, 0.3)
    Xte = Xte[Xtr.columns]
    ...
    ytr_preds = model.predict(X=Xtr_orig, group=gtr_orig)
...
# %% [markdown]
# * With `correlation_threshold = 0.7` and random oversampling:
#
...
#
# * With `correlation_threshold = 0.7` and __NO__ random oversampling:
#
# |       |  f1_train |   f1_test | log_loss_train | log_loss_test |
# |------:|----------:|----------:|---------------:|--------------:|
# | count | 10.000000 | 10.000000 | 10.000000      | 10.000000     |
...
#
# * With `correlation_threshold = 0.7` and SMOTE oversampling:
#
# |       |  f1_train |   f1_test | log_loss_train | log_loss_test |
# |------:|----------:|----------:|---------------:|--------------:|
# | count | 10.000000 | 10.000000 | 10.000000      | 10.000000     |
# |  mean | 0.990821  | 0.668347  | 0.036228       | 0.332044      |
# |  std  | 0.006165  | 0.065133  | 0.007548       | 0.098004      |
# |  min  | 0.974874  | 0.583333  | 0.029674       | 0.182734      |
# |  25%  | 0.989691  | 0.619433  | 0.030371       | 0.282847      |
# |  50%  | 0.992334  | 0.653333  | 0.033623       | 0.347713      |
# |  75%  | 0.994872  | 0.720455  | 0.039010       | 0.366187      |
# |  max  | 0.994924  | 0.769231  | 0.049668       | 0.478071      |
#
# * With `correlation_threshold = 0.7` and SMOTENC oversampling (categorical features: ej):
#
# |       |  f1_train |   f1_test | log_loss_train | log_loss_test |
# |------:|----------:|----------:|---------------:|--------------:|
# | count | 10.000000 | 10.000000 | 10.000000      | 10.000000     |
# |  mean | 0.987304  | 0.699743  | 0.038964       | 0.347979      |
# |  std  | 0.006826  | 0.073550  | 0.011872       | 0.106279      |
# |  min  | 0.974619  | 0.545455  | 0.024870       | 0.171286      |
# |  25%  | 0.984654  | 0.675000  | 0.031958       | 0.266605      |
# |  50%  | 0.987284  | 0.710084  | 0.035730       | 0.362626      |
# |  75%  | 0.993603  | 0.732632  | 0.045389       | 0.411020      |
# |  max  | 0.994924  | 0.814815  | 0.062747       | 0.486864      |
#
# * With `correlation_threshold = 0.5` and SMOTENC oversampling (categorical features: ej):
#
# |       |  f1_train |   f1_test | log_loss_train | log_loss_test |
# |------:|----------:|----------:|---------------:|--------------:|
# | count | 10.000000 | 10.000000 | 10.000000      | 10.000000     |
# |  mean | 0.946499  | 0.715808  | 0.107304       | 0.353319      |
# |  std  | 0.010479  | 0.107823  | 0.013483       | 0.152018      |
# |  min  | 0.931373  | 0.538462  | 0.079418       | 0.143591      |
# |  25%  | 0.938289  | 0.666667  | 0.102167       | 0.272387      |
# |  50%  | 0.947884  | 0.723636  | 0.109192       | 0.324499      |
# |  75%  | 0.955327  | 0.744318  | 0.115411       | 0.411712      |
# |  max  | 0.959596  | 0.952381  | 0.125905       | 0.622733      |
#
# * __With `correlation_threshold = 0.4` and SMOTENC oversampling (categorical features: ej):__
#
# |       |  f1_train |   f1_test | log_loss_train | log_loss_test |
# |------:|----------:|----------:|---------------:|--------------:|
# | count | 10.000000 | 10.000000 | 10.000000      | 10.000000     |
# |  mean | 0.933213  | 0.749716  | 0.135093       | 0.310114      |
# |  std  | 0.006461  | 0.098094  | 0.012803       | 0.105951      |
# |  min  | 0.922330  | 0.631579  | 0.112123       | 0.157604      |
# |  25%  | 0.927424  | 0.648810  | 0.128631       | 0.237548      |
# |  50%  | 0.935961  | 0.775000  | 0.136152       | 0.328245      |
# |  75%  | 0.936429  | 0.818182  | 0.142162       | 0.379738      |
# |  max  | 0.941748  | 0.900000  | 0.155758       | 0.466184      |
#
# * With `correlation_threshold = 0.3` and SMOTENC oversampling (categorical features: ej):
#
# |       |  f1_train |   f1_test | log_loss_train | log_loss_test |
# |------:|----------:|----------:|---------------:|--------------:|
# | count | 10.000000 | 10.000000 | 10.000000      | 10.000000     |
# |  mean | 0.914049  | 0.714938  | 0.157241       | 0.352099      |
# |  std  | 0.019787  | 0.060701  | 0.021003       | 0.104029      |
# |  min  | 0.886792  | 0.666667  | 0.120598       | 0.160491      |
# |  25%  | 0.898585  | 0.666667  | 0.141767       | 0.284207      |
# |  50%  | 0.909522  | 0.697826  | 0.162877       | 0.391602      |
# |  75%  | 0.934028  | 0.737374  | 0.173093       | 0.439471      |
# |  max  | 0.940594  | 0.857143  | 0.184846       | 0.445748      |
