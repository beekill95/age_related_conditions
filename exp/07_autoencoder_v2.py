...
# to a small subspace.
# This experiment is similar to the first version,
# the only difference is that the embedded features are normalized.
...
for fold, (train_idx, val_idx) in enumerate(kfold.split(X, y)):
    ...
    Xtr_encoded = scaler.fit_transform(Xtr_encoded)
    ...
    Xva_encoded = scaler.transform(Xva_encoded)
