...
#
# We will choose features that are not correlated with each other.
...
for fold, (train_idx, val_idx) in enumerate(kfold.split(X_df, y)):
    ...
    Xtr_df = filter_correlated_features(Xtr_df, 0.3)
...
# %% [markdown]
# Previous run, using normal logistic regression model: (no correlated features removal)
#
# * Train - F1=0.4279 +- 0.0376; Log Loss = 0.4981 +- 0.0234
# * Valid - F1=0.4825 +- 0.1822; Log Loss = 0.5059 +- 0.0742
#
# With the robust regression, we see improvements in the scores: (no correlated features removal)
#
# * Train - F1=0.4860 +- 0.0433; Log Loss = 0.4941 +- 0.0269
# * Valid - F1=0.4993 +- 0.1230; Log Loss = 0.4866 +- 0.0522
#
# With the robust regression and correlated features removal:
#
# * Train - F1=0.4262 +- 0.0709; Log Loss = 0.5278 +- 0.0327
# * Valid - F1=0.4868 +- 0.1379; Log Loss = 0.5069 +- 0.0464
