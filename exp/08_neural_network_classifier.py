...
def train(model: nn.Module,
    ...
    train_step, val_step = create_training_and_evaluation_step(
        model, weight_decay=1e-2, regularization_weight=1.)
    train_losses = []
    val_losses = []
...
#
# - Train - F1=0.9964 +- 0.0040; Log Loss = 0.0140 +- 0.0093
# - Valid - F1=0.8090 +- 0.1070; Log Loss = 0.4171 +- 0.1791
#
# With `regularization_weight = 1.0`:
#
# - Train - F1=0.9917 +- 0.0062; Log Loss = 0.0636 +- 0.0176
# - Valid - F1=0.7499 +- 0.0847; Log Loss = 0.3964 +- 0.1219
