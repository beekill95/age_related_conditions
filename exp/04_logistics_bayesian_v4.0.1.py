...
# %% [markdown]
# Our derived best probability predictions is better than the one given by jax's `minimize`
# function, and a lot faster!
...
# Instead of using minimize function,
